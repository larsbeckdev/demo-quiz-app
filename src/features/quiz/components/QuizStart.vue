...
const props = defineProps<{
  lastRun: { quizId: string; score: number; total: number; finishedAt: number } | null;
}>();
...
<template>
  <div class="card shadow-sm">
    <div class="card-body">
      ...
      <p class="text-muted mb-3">Starte das Quiz und beantworte die Fragen nacheinander.</p>
      ...
      <div v-if="props.lastRun" class="alert alert-light border">
        ...
        <div class="fw-semibold">
          ...
          <span class="text-muted fw-normal">· {{ formatDate(props.lastRun.finishedAt) }}</span>
        </div>
      </div>
